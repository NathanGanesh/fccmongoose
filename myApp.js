...
// mongodb+srv://aap:<password>@cluster0.apenj.mongodb.net/<dbname>?retryWrites=true&w=majority

let MONGO_URI = "mongodb+srv://aap:nathanj1k2@cluster0.apenj.mongodb.net/db1?retryWrites=true&w=majority";
...
let peopleSchema = new mongoose.Schema({name:{type:String,required:true}, age:Number,favoriteFoods:[String] });
...
let Dave = new Person({name:'Dave', age:27, favoriteFoods:['pizza', 'mountain dew']});  
...
//   Person.findOne({favoriteFoods: foodToSearch, age:0}, (err,data) => if(!err){
//     console.log(data)
//   }).
  
    // , (err, data)=> err ? done(err) : done(null, data)).sort(1).limit(2);
